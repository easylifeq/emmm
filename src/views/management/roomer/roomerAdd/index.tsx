      ...
      >
        ...
        >
          ...
          <Form.Item
            name="dai"
            label="病房代码"
            rules={[{ required: true, message: '请输入病房代码!' }]}
          >
          ...
          <Form.Item
            name="address"
            label="病房外部代码"
            rules={[{ required: true, message: '请输入病房外部代码!' }]}
          >
            <Input placeholder="请输入病房外部代码" />
          </Form.Item>
          <Form.Item
            name="address"
            label="病房名称"
            rules={[{ required: true, message: '病房名称!' }]}
          >
            <Input placeholder="请输入病房名称" />
          </Form.Item>
          <Form.Item
            name="address"
            label="额定床位"
          ...
          <Form.Item
            name="address"
            label="关联科室"
            rules={[{ required: true, message: '关联科室!' }]}
          >
